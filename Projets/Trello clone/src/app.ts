...
function handleAddItem(e: MouseEvent) {
    ...
    if (actualContainer) toggleForm(actualBtn, actualForm, false); //pour chaque nouvel container cliqué,il le toggle et il le ferme 
...
function setContainerItems(btn: HTMLButtonElement) {
    actualBtn = btn;
    actualContainer = btn.parentElement as HTMLDivElement;//parceque le parent de btn c'est le container
    actualUL = actualContainer.querySelector('ul') as HTMLUListElement; //la liste du container
    actualForm = actualContainer.querySelector('form') as HTMLFormElement;//formulaire du container, si on veut submit par exple
    actualTextInput = actualContainer.querySelector('input') as HTMLInputElement;//input du container
    actualValidation = actualContainer.querySelector('.validation-msg') as HTMLSpanElement;//message de validation du container
}
...
function htmlItemDeletion(btn: HTMLButtonElement) {
